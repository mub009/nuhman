<?php include('include/header.php'); ?>
                    ...
                    <div class="ltn__form-box contact-form-box box-shadow white-bg">
                        ...
                        <form id="contact-form" action="email.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-item input-item-name ltn__custom-icon">
                                        <input type="text" name="email_name" placeholder="Enter your name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-item input-item-email ltn__custom-icon">
                                        <input type="email" name="email_from" placeholder="Enter email address">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-item">
                                        <select class="nice-select" name="serive" id="service">
                            ...
                            <div class="btn-wrapper mt-0">
                                <button class="btn-contact btn theme-btn-1 btn-effect-1 text-uppercase" type="submit"  name="submit">get a free service</button>
                            </div>
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d125745.71978105475!2d76.23825225461226!3d9.971036375695851!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b080d08f976f3a9%3A0xe9cdb444f06ed454!2sErnakulam%2C%20Kerala!5e0!3m2!1sen!2sin!4v1655187466587!5m2!1sen!2sin" width="100%" height="100%" frameborder="0" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
