<?php include('include/header.php'); ?>
    ...
    <div class="ltn__page-details-area ltn__service-details-area mb-105">
        ...
        <div class="ltn__breadcrumb-inner">
                        ...
                        <h1 class="page-title">AUTO CAD Drafting Services</h1>
                    </div>
            <div class="row">
                <div class="col-lg-8">
                ...
                <div class="col-lg-4">
                    <aside class="sidebar-area ltn__right-sidebar">
                        ...
                        <div class="widget-2 ltn__menu-widget ltn__menu-widget-2 text-uppercase">
                            <ul>
                                <li>Architectural CAD Drafting Services </li>
                                <li>Architectural Drawings </li>
                                <li>CADD drafting for floor plans, Elevation and Site </li>
                                <li>Cad Conversion from a PDF/ paper drawing </li>
                                <li>Shop Drawings </li>
                                <li>Architectural 2d CAD Drafting </li>
                                <li>Furniture Layout Modeling </li>
                            </ul>
                        </div>
