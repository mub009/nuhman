...
?>
    ...
    <div class="ltn__slider-area ltn__slider-3  section-bg-2---">
        <div class="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1">
            <!-- ltn__slide-item -->
            <div class="ltn__slide-item ltn__slide-item-2  ltn__slide-item-3-normal--- ltn__slide-item-3 bg-image bg-overlay-theme-black-20  text-color-white" data-bg="img/slider/slider1.jpg">
                            ...
                            <div class="col-lg-12 align-self-center">
                                <div class="slide-item-info">
                                    <div class="slide-item-info-inner ltn__slide-animation" >
                                        ...
                                        <h1 class="slide-title animated ">UK Architectural Services</h1>
                                        <div class="slide-brief animated">
                                            <p>UK architectural services for both residential and commercial buildings.</p>
                                        </div>
                                        <div class="btn-wrapper animated">
                                            <a href="contact.php" class="theme-btn-1 btn btn-effect-1">Get A Quate</a>
                                            <a href="about.php" class="theme-btn-2 btn btn-effect-2">Learn More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- ltn__slide-item -->
            <div class="ltn__slide-item ltn__slide-item-2  ltn__slide-item-3-normal--- ltn__slide-item-3 bg-image bg-overlay-theme-black-40  text-color-white" data-bg="img/slider/slider2.jpg">
                        ...
                        <div class="row">
                            <div class="col-lg-12 align-self-center">
                                <div class="slide-item-info">
                                    <div class="slide-item-info-inner ltn__slide-animation">
                                        <!-- <h6 class="slide-sub-title ltn__secondary-color--- animated text-uppercase"><span><i class="fas fa-square-full"></i></span> Great Experience In Building</h6> -->
                                        <h1 class="slide-title animated ">BIM services</h1>
                                        <div class="slide-brief animated">
                                            <p>Building information modeling for architecture and structural sectors.</p>
                                        </div>
                                        <div class="btn-wrapper animated">
                                            <a href="contact.php" class="theme-btn-1 btn btn-effect-1">Get A Quate</a>
                                            <a href="about.php" class="theme-btn-2 btn btn-effect-2">Learn More</a>
            ...
            <!-- ltn__slide-item -->
            <div class="ltn__slide-item ltn__slide-item-2  ltn__slide-item-3-normal--- ltn__slide-item-3 bg-image bg-overlay-theme-black-40  text-color-white" data-bg="img/slider/slider3.jpg">
                        ...
                        <div class="row">
                            <div class="col-lg-12 align-self-center">
                                <div class="slide-item-info">
                                    <div class="slide-item-info-inner ltn__slide-animation">
                                        <!-- <h6 class="slide-sub-title ltn__secondary-color--- animated text-uppercase"><span><i class="fas fa-square-full"></i></span> Great Experience In Building</h6> -->
                                        <h1 class="slide-title animated ">3D Visualization</h1>
                                        <div class="slide-brief animated">
                                            <p>We offer quality Architectural 3d renderings and visualization services</p>
                                        </div>
                                        <div class="btn-wrapper animated">
                                            <a href="contact.php" class="theme-btn-1 btn btn-effect-1">Get A Quate</a>
                                            <a href="about.php" class="theme-btn-2 btn btn-effect-2">Learn More</a>
            ...
            <div class="row">
                <div class="col-lg-7 align-self-center">
                    <div class="about-us-info-wrap">
                        <div class="section-title-area ltn__section-title-2">
                            ...
                            <h1 class="section-title">What we Are!</h1>
                            <p>BIM Mark is an Engineering service providing company primarily focusing on Architectural and Structural drawings.
                                 We offers Building Information Modeling (BIM) and CAD services for various Architecture,
                                  Engineering & Construction (AEC) firms globally. 
                                Our Team has around 20+ members which includes architects, engineers, interior designers, and CAD technicians.</p>
                        </div>
                        <div class="about-us-info-wrap-inner about-us-info-devide">
                            <p>We are better equipped to analyze and understand the effective use of available resources.
                                 Through our adherence to a quality management system, 
                                 we demonstrate our commitment to quality and excellence to our customers. 
                                 We focus on .. <span class="ltn__secondary-color">Read More</span></p>
                            <div class="list-item-with-icon">
                                <ul>
                                    <li><a href="contact.php">Excellence</a></li>
                                    <li><a href="team.php">Teamwork</a></li>
                                     <a class="ltn__secondary-color" href="about.php">Read More</a>
                ...
                <div class="col-lg-5 align-self-center">
                    <div class="get-a-quote-wrap">
                        ...
                        <img src="img/others/aboutt.jpg" alt="img">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-sm-6">                            
                    <div class="ltn__feature-item ltn__feature-item-6 box-shadow-1">
                        ...
                        <div class="ltn__feature-info">
                            ...
                            <p>We creates high quality interior and exterior realistic architectural 3D renderings and animations.</p>
                            <a class="ltn__service-btn ltn__service-btn-2" href="service-details_3D.php">Service Details <i class="flaticon-right-arrow"></i></a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="ltn__progress-bar-item-2 text-center">
                                        <div class="progress" data-value='78'>
                                            ...
                                            <div class="progress-value">
                                                <div class="progress-count">20<sup class="small">+</sup></div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-2 col-sm-4">
                                    <div class="ltn__progress-bar-item-2 text-center">
                                        <div class="progress" data-value='62'>
                                            ...
                                            <div class="progress-value">
                                                <div class="progress-count">100<sup class="small">+</sup></div>
                                            </div>
                                        </div>
                                        <div class="ltn__progress-info">
                                ...
                                <div class="col-lg-2 col-sm-4">
                                    <div class="ltn__progress-bar-item-2 text-center">
                                        <div class="progress" data-value='50'>
                                            ...
                                            <div class="progress-value">
                                                <div class="progress-count">05<sup class="small">+</sup></div>
                                            </div>
                                        </div>
                                        <div class="ltn__progress-info">
                    ...
                    <div class="ltn__img-slide-item-3">
                        ...
                        <div class="ltn__img-slide-info">
                            <div class="ltn__img-slide-info-brief">
                                <h6>Construction</h6>
                                <h1><a href="portfolio-details.php">Industrial construction</a></h1>
                            </div>
                            <div class="btn-wrapper">
                                <a href="portfolio-details.php" class="btn theme-btn-1 btn-effect-1"><i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="call-to-action-inner call-to-action-inner-6 p-0 text-center---">
                        ...
                        <div class="btn-wrapper">
                            <a class="btn btn-effect-4 btn-white font-weight-bold" href="contact.php">Shedule Work <i class="icon-next"></i></a>
                        </div>
                    </div>
                </div>
            </div>
