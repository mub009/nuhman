<?php include('include/header.php'); ?>
    ...
    <div class="ltn__page-details-area ltn__service-details-area mb-105">
        ...
        <div class="ltn__breadcrumb-inner">
                        ...
                        <h1 class="page-title">Construction Documentation</h1>
                    </div>
            <div class="row">
                <div class="col-lg-8">
                ...
                <div class="col-lg-4">
                    <aside class="sidebar-area ltn__right-sidebar">
                        ...
                        <div class="widget-2 ltn__menu-widget ltn__menu-widget-2 text-uppercase">
                            <h3>Our Structural documentation services include</h3>
                            <ul>
                                <li>General Structural Notes</li>
                                <li>Structural Foundation Plan</li>
                                <li>Overall Beam Layout</li>
                                <li>Overall Column Layout</li>
                                <li>Structural Roof Layout</li>
                                <li>Structural Framing Plans</li>
                                <li>Overall Slab Layout</li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__page-details-inner ltn__service-details-inner">
                        ...
                        <p>	Section drawings are a specific type of drawing architects use to illustrate a building or portion of a building. A section is drawn from a vertical plane slicing through a building. This type of construction drawing helps to identify the primary structures in relation to other surrounding structures of the building. In addition, the section reveals simultaneously its interior and exterior profiles and providing a view of the object that is not usually seen.</p>
                        
                        <h3>5. Block Plan</h3>
                        <p>A block plan is the representation of a larger area that is in the vicinity of the main building under construction. A block plan may include adjoining buildings, roads, boundaries, and other similar components. More importantly, a block plan is represented in scales, which also means that they cover a wide area.</p>
